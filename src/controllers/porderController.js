...
exports.createPOrder = async (req, res) => {
  try {
    let data  = req.body;
...
exports.listPOrders = async (req, res) => {
  try {
...
exports.updatePOrder = async (req, res) => {
  const { id } = req.params;
...
exports.findPOrderById = async (req, res) => {
  const { id } = req.params;
  try {
    const result = await quoteService.findQuote(id);
...
exports.deletePOrderById = async (req, res) => {
  const { id } = req.params;
  try {
